...
from free.views import AllListView
from notice.models import Notice

from .forms import CsRegisterForm, LoginForm, CustomCsUserChangeForm, CheckPasswordForm, RecoveryIdForm, RecoveryPwForm, CustomPasswordChangeForm
...
class CsRegisterView(CreateView):
    ...
    def form_valid(self, form):
        ...
        send_mail(
            '[FOCUS] {}님의 회원가입 인증메일 입니다.'.format(self.object.user_id),
            [self.object.email],
