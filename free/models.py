...
from users.choice import CATEGORY_CHOICES,CATEGORY2_CHOICES
...
class Free(models.Model):
    ...
    category2 = models.CharField(choices=CATEGORY2_CHOICES, max_length=18, verbose_name='카테고리', default='기타')
